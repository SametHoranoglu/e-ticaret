...
class Veritabanim {
    ...
    function __construct() {       
        $this->dsn = 'mysql:host=localhost;dbname=e-ticaret;charset=utf8';
        $this->user = 'root';
        $this->password = '';
    }
...
$dbs = new PDO("mysql:host=localhost;dbname=e-ticaret", 'root','');
 function sili($tablo,$where) {
        $db = new PDO("mysql:host=localhost;dbname=e-ticaret", 'root','');
